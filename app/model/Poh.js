...
Ext.define('Vega.model.Poh', {
    ...
    fields: [
        { name: 'pono', type: 'int'},
        { name: 'orderDate', convert: df },
        { name: 'startDate', convert: df },
        { name: 'cancelDate', convert: df },
        ...
        { name: 'fabric_alloc_date', convert: df },
        { name: 'fabric_pull_date', convert: df },
        { name: 'fit_approv_date', convert: df },
        { name: 'marker_no', type: 'string', convert: tr},
        { name: 'qb_batch_no', type: 'int'},
        { name: 'qb_batch_date', convert: df },
        { name: 'bulkpo', type: 'string', convert: tr},
        { name: 'bulkpono', type: 'int'},
        { name: 'insurance_expdate', convert: df },
        ...
        { name: 'cutReleaseDate', convert: df },
        { name: 'cutFinishDate', convert: df },
        { name: 'sewingPickupDate', convert: df },
        { name: 'sewingDueDate', convert: df },
