...
Ext.define('Vega.view.settings.view.development.Default', {
    extend: 'Ext.panel.Panel',

    requires: [
        'Vega.view.settings.view.development.DefaultController',
        'Vega.view.settings.view.development.DefaultModel'
    ],

    alias: 'widget.view-development-default',

    controller: 'view-development-default',
    viewModel: {
        type: 'view-development-default'
    },
