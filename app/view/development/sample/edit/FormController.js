Ext.define('Vega.view.development.sample.edit.FormController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.sample-edit-form',
    ...
    init: function(){
        ...
        console.log('init', vm.linkData.theStyle);
        console.log('init', this.getReferences().boms)
    },

    initViewModel: function(vm) {

        var rec = vm.linkData.theStyle;
    ...
    onTabChange: function(t, n, o, e){
        ...
        btn.setHidden(n.reference != 'boms')
    },
