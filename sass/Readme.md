...
folder are mapped to the application's root namespace, 'Vega3s'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Vega3s' in the same way
as `"Vega3s/sass/src"`.
